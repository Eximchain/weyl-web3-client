...
const buildWeylClient = (url) => {
    const web3 = new Web3(new Web3.providers.HttpProvider(url));
    return new web3.eth.Contract(WeylABI, '0x000000000000000000000000000000000000002A');
}

const buildBlockmakerChecker = (url) => {
    const web3 = new Web3(new Web3.providers.HttpProvider(url));
...
module.exports.default = (url) => {
    return {
        contract : buildWeylClient(url),
        isBlockMaker : buildBlockmakerChecker(url)
    }
};